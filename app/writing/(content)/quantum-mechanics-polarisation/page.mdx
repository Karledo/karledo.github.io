...
<article>
    ...
    Let's imagine another example. Let's say that you had light which was polarized at angle of <Latex text="$25 \degree$" /> from the vertical trying to pass through a vertically oriented polarizing filter.
